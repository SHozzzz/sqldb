...
/****** Object:  Database [testBD]    Script Date: 01.03.2024 10:16:57 ******/
CREATE DATABASE [testBD]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'testBD', FILENAME = N'D:\SQL2022\MSSQL16.SQLEXPRESS\MSSQL\DATA\testBD.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'testBD_log', FILENAME = N'D:\SQL2022\MSSQL16.SQLEXPRESS\MSSQL\DATA\testBD_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO

create table thirdTable(
  ID int primary key,
  fivename nvarchar(50),
  sixname nvarchar(50)
  sevenname nvarchar(50),
);
...
ALTER DATABASE [testBD] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [testBD] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [testBD] SET QUERY_STORE = ON
GO

ALTER DATABASE [testBD] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
